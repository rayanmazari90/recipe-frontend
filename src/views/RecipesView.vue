          ...
          <b-form-group
            ...
            <b-form-group
              ...
              <b-form-checkbox
                  ...
                  style="accent-color: rgb(27,135,84);  zoom:1.3; font-size: 80%;"
                >
                &ensp; Add As Favorite
              </b-form-checkbox>
            </b-form-group>
            <br>
...
<!-- End of Modal for Create Recipe-->
    ...
    >
      <b-form @submit="onSubmitUpdate" class="w-100">
        ...
        <b-form-group
                id="form-edit-favourites-group"
                label="Is it your favourite:"
                label-for="form-name-input"
              >    
        <b-form-checkbox
            id="checkbox-1"
            v-model="editRecipeForm.favourites"
            name="checkbox-1"
            value="true"
            unchecked-value="false" 
            style="accent-color: rgb(27,135,84);  zoom:1.3; font-size: 80%;"
...
methods: {
    ...
    axios
      ...
      .then((response) => {
        ...
        this.recipes.sort(function(a, b) {
            return b.favourites - a.favourites || b.rating - a.rating;
        });
      })
      .catch((error) => {
        console.error(error);
  ...
  initForm() {
    ...
    this.editRecipeForm.favourites="";
  },
